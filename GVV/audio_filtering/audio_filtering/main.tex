...
\author{EE23BTECH11042-M KHUSINADHA NAIK$^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
https://github.com/Meowfessor96/audio_filtering/blob/main/audio_filtering/codes/audio.wav
\end{lstlisting}
\item 
\label{Python code}
Audio filtering is carried out using the following Python Code
\begin{lstlisting}
...
\end{lstlisting} \label{prob:audio_filter_problem}
%\lstinputlisting{./codes/audio_filter.py}\label{prob:audio_filter_problem}
\item 
Audio is analysed using a spectrogram found in the following website :\\
\href{/url{https://www.checkhearing.org/audiospectrum.php}} \\
The figures represent the distribution of sound among frequencies in the x axis and similarly the y-axis represents the intensity of the sound \\
\begin{figure}[ht]
    \includegraphics[width=0.8\columnwidth]{figs/Audio_Before_Filtering.png }
    \caption{frequenxy distribution of the audio file before Filtering(at 0:20)}
    \label{fig:Before_Filtering}
\end{figure}
\begin{figure}[ht]
\includegraphics[width=0.8\columnwidth]{figs/Audio_After_Filtering.png}
    \caption{frequenxy distribution of the audio file after Filtering(at 0:20)}
    \label{fig:After_Filtering}
\end{figure}
\end{enumerate}
...
Sketch $y(n)$.\\
Solve\\
\solution  $x(n)$ and $y(n)$ values for different values of $n$ are generated in a text file using C file.
\begin{lstlisting}
https://github.com/Meowfessor96/audio_filtering/blob/main/audio_filtering/codes/2_2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Meowfessor96/audio_filtering/blob/main/audio_filtering/codes/2.2.py
\end{lstlisting}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\columnwidth]{figs/y(n)_vs_n.png}
...
\\
&=\sum _{n=-\infty }^{\infty }x(n)z^{-n-1} = z^{-1}\sum _{n=-\infty }^{\infty }x(n)z^{-n} \\ &= z^{-1}X(z)
\end{align}
...
\solution 
\begin{align}
	a^nu(n) &\system{Z} \sum_{n = 0}^{\infty}\brak{a^nz^{-n}} \\
...
\\
\solution The DTFT of the transfer function is plotted using the following code
\begin{lstlisting}
https://github.com/Meowfessor96/audio_filtering/blob/main/audio_filtering/codes/3.5.py
\end{lstlisting}
...
\end{align}
A function $f(x)$ is said to be periodic of time period $T$ if $f(x+nT) = f(x)$, $n \in \mathcal{Z}$
\begin{align}
...
\caption{DTFT, $\abs{H\brak{e^{j\omega}}}$}
\label{fig:H(z)_3.5}
\end{figure}
\end{enumerate}
...
\begin{lstlisting}
https://github.com/Meowfessor96/audio_filtering/blob/main/audio_filtering/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Meowfessor96/audio_filtering/blob/main/audio_filtering/codes/4.4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/Meowfessor96/audio_filtering/blob/main/audio_filtering/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Meowfessor96/audio_filtering/blob/main/audio_filtering/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Meowfessor96/audio_filtering/blob/main/audio_filtering/codes/5.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Meowfessor96/audio_filtering/blob/main/audio_filtering/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Meowfessor96/audio_filtering/blob/main/audio_filtering/codes/6.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\solution
From the output of a and b from code in Problem \ref{prob:audio_filter_problem}, and
from \ref{eq:iir_filter_gen} \\
\begin{align}
    &\notag a\brak{0}y\brak{n} + a\brak{1}y\brak{n-1}+a\brak{2}y\brak{n-2}+a\brak{3}\\ \notag &y\brak{n-3} + a\brak{4}y\brak{n-4} =   b\brak{0}x\brak{n} + b\brak{1}x\brak{n-1}\\ &+b\brak{2}x\brak{n-2}+b\brak{3}x\brak{n-3} + b\brak{4}x\brak{n-4} 
\end{align}
...
\end{align}
M = N = 5 \\
Looking at scipy documentation at \href{https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.residuez.html}{https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.residuez.html}, the 
...
\end{align}
Whose values can be obtained using the scipy.signal.residuez function.
Now,
\begin{align}
    r^{n}u\brak{n} \system{Z} \frac{1}{1-rz^{-1}} , \quad \abs{z} > \abs r \label{eq:res-1}\\
...
\end{align}
\begin{lstlisting}
https://github.com/Meowfessor96/audio_filtering/blob/main/audio_filtering/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Meowfessor96/audio_filtering/blob/main/audio_filtering/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/h(n)_6.2.png}
\caption{Plot of h(n)}
\label{fig:h(n)_6th_q}
\end{figure}
\begin{figure}[H]
\centering
